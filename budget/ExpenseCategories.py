...
expenses.read_expenses('data/spending_data.csv')
    '''
    print(timeit.timeit(stmt="expenses.categorize_for_loop()" ,setup=setup,number=100000,globals=globals))
    print(timeit.timeit(stmt="expenses.categorize_set_comprehension()" ,setup=setup,number=100000,globals=globals))
    ...
    for category_exps in divided_set_comp:
        divided_expenses_sum.append(category_exps)
